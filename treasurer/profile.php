    ...
    if ($action === 'update_email') {
        ...
        if (empty($new_email) || empty($password)) {
            ...
            if (!password_verify($password, $user['password'])) {
                ...
                $check_query = "SELECT id FROM members WHERE email = :email AND member_id != :member_id";
                    ...
                    <div class="col-md-8">
                        <table class="table">
                            <tr>
                                ...
                                <td><?php echo $treasurer['member_id']; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo date('F j, Y', strtotime($treasurer['created_at'])); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    $last_login_query = "SELECT timestamp FROM audit_logs 
                                                        WHERE user_id = :user_id AND action = 'Treasurer login successful' 
                                    ...
                                    echo $last_login ? date('F j, Y g:i A', strtotime($last_login['timestamp'])) : 'First login';
                                    ?>
                                </td>
                            </tr>
                        </table>
                        ...
                        <tbody>
                            <?php foreach ($recent_logs as $log): ?>
                                <tr>
                                    ...
                                    <td><small><?php echo date('M d, Y g:i A', strtotime($log['timestamp'])); ?></small></td>
                                </tr>
                            <?php endforeach; ?>
